...
describe('resolveSpecialRoleTriggers - 特殊角色触发逻辑', () => {
  ...
  describe('猎人开枪', () => {
    it('猎人被放逐时应触发开枪', () => {
      ...
      const players = [hunter, createPlayer('p2', 2), createPlayer('p3', 3)];
    ...
    it('猎人夜晚被刀死时应触发开枪', () => {
      const hunter = createPlayer('p1', 1, { role: 'hunter', faction: 'villager' });
      const players = [hunter, createPlayer('p2', 2)];
  ...
  describe('狼王开枪', () => {
    it('狼王被放逐时应触发开枪', () => {
      ...
      const players = [wolfKing, createPlayer('p2', 2)];
    ...
    it('狼王夜晚死亡时不能开枪', () => {
      ...
      expect(result.wolfKingPlayerId).toBeNull();
    });
  ...
  describe('白痴翻牌', () => {
    it('白痴被放逐时应翻牌免疫', () => {
      ...
      const players = [idiot, createPlayer('p2', 2)];
