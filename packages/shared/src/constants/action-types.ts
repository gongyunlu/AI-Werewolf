...
export const ACTION_TYPES = {
  ...
  GUARD_PROTECT: 'guard_protect', // 守卫守护(预留,视板子)
  BEAR_GROWL: 'bear_growl', // 熊咆哮(预留,视板子)

  // —— 白天特殊技能 ——
  HUNTER_SHOT: 'hunter_shot', // 猎人开枪(预留,MVP 6 人板无猎人)
  WOLF_KING_SHOT: 'wolf_king_shot', // 狼王开枪(预留)
  IDIOT_FLIP: 'idiot_flip', // 白痴翻牌(预留)
  ...
  SAVIOR_GUESS: 'savior_guess', // 救世主技能(注:值名沿用历史不可改;咒狐 fox 为独立角色,技能事件待其机制定稿后另加)
